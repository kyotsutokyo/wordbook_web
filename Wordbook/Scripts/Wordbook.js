$(document).ready(function () {
    ...
    $('#AddWord').on( 'click', function (e) {
        ...
        var translation = ('#inputTranslation').val();
        ...
        client.ad('limingliang@kyotsu.com', function (result) {
    ...
    $('.popover-dismiss').popover({
        ...
        html:true,
        title:'単語を追加する',
        content:'<h3 >And here s some amazing content. It s very engaging. Right?</h3>',
   ...
   $('#DeleteWord').on( 'click', function (e) {
    ...
    $('#LoadData').on( 'click', function (e) {
        e.preventDefault();
            ...
            var protocol = new Thrift.TJSONProtocol(transport);
            var client = new WordbookThriftServiceClient(protocol);
            client.getWords('limingliang@kyotsu.com', function (result) {
...
function format(d) {
    ...
    return '<table cellpadding="5" cellspacing="0" border="0" style="padding-left:50px;">' +
		'<tr>' +
			'<td>意味:</td>' +
			'<td>' + d[2] + '</td>' +'<td><button type="button" class="btn ladda-button " data-style="zoom-in" data-size="l" id="EditWord"><span class="ladda-label">編集</span></button></td>' +
		'</tr>' +
	'</table>';
}
